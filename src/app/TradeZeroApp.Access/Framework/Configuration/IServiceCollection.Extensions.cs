...
/// </summary>
/// <remarks>
/// Note that the class name starts with "TradeZeroApp" to avoid potential collisions since we use the original namespace of <see cref="IServiceCollection"/>.
/// </remarks>
public static class TradeZeroAppServiceCollectionExtensions
{
	/// <summary>
	...
	/// (see <see cref="TradeZeroAppConfigurationExtensions.DefaultOptionsName(Type)"/>.
	/// </param>
