...
/// </summary>
/// <remarks>
/// Note that the class name starts with "TradeZeroApp" to avoid potential collisions since we use the original namespace of <see cref="IConfigurationSection"/>.
/// </remarks>
public static class TradeZeroAppConfigurationExtensions
{
	/// <summary>
